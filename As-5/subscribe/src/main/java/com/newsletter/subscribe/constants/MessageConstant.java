...
public class MessageConstant {
  ...
  public static final String USER_CREATION_FAILED = "Could not create user";
  public static final String USER_LIST_FETCH_FAILED = "Could not get user list";
  public static final String USER_FETCH_FAILED = "Could not get user details";
  public static final String USER_UPDATE_FAILED = "Could not update user details";
  public static final String USER_DELETION_FAILED = "Could not delete user";
  public static final String INVALID_JWT_TOKEN = "Invalid Authorization Token";
   ...
   */
  public static final String UNAUTHORIZED_ACCESS = "Permission Denied: Unauthorized access";
  ...
  public static final String ID_NOT_FOUND =
      "Provided user is not subscribed to provided subscription";
  public static final String SUBSCRIPTION_ALREADY_EXISTS =
      "You have already subscribed to this subscription";
